...
public class AkUEPlatform_TVOS : AkUEPlatform
{
	...
	public override List<string> GetPublicLibraryPaths()
	{
		...
		{
			Path.Combine(ThirdPartyFolder, "tvOS", akConfigurationDir + "-appletvos", "lib")
		};
	}

	public override List<string> GetAdditionalWwiseLibs()
	{
		var libs = GetAllLibrariesInFolder(Path.Combine(ThirdPartyFolder, "tvOS", akConfigurationDir + "-appletvos", "lib"), "*.a");
