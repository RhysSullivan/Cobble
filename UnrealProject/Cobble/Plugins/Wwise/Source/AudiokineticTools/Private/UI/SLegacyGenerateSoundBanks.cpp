...
bool SLegacyGenerateSoundBanks::EnsureSoundBankPathIsInPackagingSettings()
{
...

	{
		...
		{
			OpenMsgDlgInt(EAppMsgType::Ok, NSLOCTEXT("AkAudio", "Error_SBFolderContainsAssets", "Unable to generate SoundBanks. Please ensure your Sound Data folder does not contain Unreal Assets. It should only contain SoundBank files."), LOCTEXT("AkAudio_Error", "Error"));
			return false;
		}
	}
